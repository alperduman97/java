...
public class C07_Runner {
    /*
    eğer  özellikler method olarak olusturuldu ise
    objenin tasidigi özellikleri belirlemek için
    Data türünün yaninda Constructor'da etkili olur


   Bir objenin istenen özelliği tasiyip tasimadigini
   data türü belirler


   O özelliğim daha guncel degerinin olup olmadigi ise constructor'a bağldiri
   objenin  özelliği bulunduktan sonra
   constructor'in olduğu class'a kadar
   daha güncel bilgi bulursa onu kullanır.
